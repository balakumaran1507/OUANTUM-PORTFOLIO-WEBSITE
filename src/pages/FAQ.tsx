...
const SECTION_COLORS = [
  '#4ade80', // AI in Construction
  '#60a5fa', // Infrastructure
  '#f472b6', // BIM & Digital Twins
  '#fb923c', // Structural Engineering
  '#a78bfa', // Construction Management
  '#facc15', // Future Engineering
];
    ...
    >
      ...
      <header>
        ...
        >
          <div className="container">
            ...
            >
              30 QUESTIONS · 6 CATEGORIES · EXPERT ANSWERS
            </motion.span>
            ...
            >
              Everything you need to know about AI in construction, infrastructure monitoring,
      ...
      <div className="container" style={{ maxWidth: '860px', margin: '0 auto' }}>
        {faqData.map((section, sectionIdx) => {
          const color = SECTION_COLORS[sectionIdx] ?? '#fff';
          return (
            <motion.section
              key={section.title}
